...
/**
 * A collection of packets that go together, for example a notification or
 * screen update.
 */
public class WatchMessage {

	private List<WatchPacket>	packets	= new ArrayList<WatchPacket>();

	public List<WatchPacket> getPackets() {
		return packets;
	}
