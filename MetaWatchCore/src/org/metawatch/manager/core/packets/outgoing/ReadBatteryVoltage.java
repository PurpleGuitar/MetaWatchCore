...
public class ReadBatteryVoltage extends DefaultWatchPacket {

	public ReadBatteryVoltage() {
		initializeBytes(4);
		bytes[PacketConstants.MESSAGE_TYPE_BYTE_LOCATION] = MessageType.ReadBatteryVoltageMsg.msg;
	}
